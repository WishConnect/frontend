...
export default function ScholarshipCard({ scholarship }: ScholarshipCardProps) {
  ...
  return (
    <div className="group relative w-full overflow-hidden rounded-2xl border border-[#E6E7EB] bg-white">
      ...
      {status === 'done' && (
        <div className="absolute right-4 top-[68px] flex size-7 items-center justify-center rounded-full bg-white text-[#7962ED]">
          ✓
        </div>
      )}
      ...
      <div className="relative -mt-6 flex flex-col rounded-2xl bg-white p-6 shadow-[0_-2px_10px_0_rgba(0,0,0,0.1)]">
        <div className="flex flex-col gap-2">
          ...
          <div className="flex flex-col gap-1">
            <h3 className="text-xl font-semibold leading-7 tracking-[-0.005em] text-[#0A0C11]">{title}</h3>
